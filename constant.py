...
adj_neg = ['Disciplined', 'Dark', 'Exceptional', 'Quick-Witted', 'Fair', 'Creative', 'Concerned', 'Conscientious',
           ...
           'Receptive', 'Quiet', 'Forgiving', 'Vivacious', 'Light-Hearted', 'Wise', 'Private', 'Versatile',
           'Warmhearted',
           ...
           'Funny', 'Plausible', 'Exclusive', 'Willing', 'Unusual', 'Righteous', 'Modest', 'Fascinating',
           'Hypochondriac',
           'Ambitious', 'Sincere', 'Plucky', 'Smiling', 'Directed', 'Attractive', 'Imaginative', 'Integrity',
           'Alluring',
           'Patient', 'Serious', 'Debonair', 'Spunky', 'Proper', 'Beautiful', 'Jovial', 'Lovely', 'Rude',
           'Discriminating',
           ...
           'Amused', 'Ugly', 'Poor', 'Efficient', 'Ingenious', 'Cool', 'Arrogant', 'Noisy', 'Fanatic', 'Unique',
           'Shrewd',
           ...
           'Fun-Loving', 'Enthusiastic', 'Comfortable', 'Capable', 'Accurate', 'Careless', 'Seemly', 'Harmonious',
           'Naïve',
           'Adorable', 'Responsible', 'Adept', 'Earnest', 'Exciting', 'Decorous', 'Rational', 'Sympathetic',
           'Materialistic',
           'Considerate', 'Talented', 'Handsome', 'Firm', 'Responsive', 'Gracious', 'Impartial', 'Impromptu',
           'Thrilling',
           'Boundless', 'Easygoing', 'Noble', 'Amazing', 'Adventurous', 'Thorough', 'Attentive', 'Unassuming',
           'Agreeable',
           ...
           'Hard-Working', 'High-Flier', 'Inscrutable', 'Communicative', 'Resolute', 'Deranged', 'Sensitive',
           'Interesting',
           'Aware', 'Keen', 'Painstaking', 'Feminine', 'Relaxed', 'Selective', 'Problem-Solver', 'Spirited',
           'Dedicated',
           ...
           'Influential', 'Insightful', 'Composed', 'Neat', 'Good', 'Self-Confident', 'Reserved', 'Persistent',
           'Tactful',
           'Demanding', 'Loyal', 'Organized', 'Bright', 'Frustrated', 'Embarrassed', 'Smart', 'Elated', 'Calm',
           'Observant',
